...
public class UserRegisterPageUI {
	...
	public static final String FIRTNAME_ERROR_MESSAGE_TEXTBOX = "//span[@id='FirstName-error']";
	public static final String LASTNAME_ERROR_MESSAGE_TEXTBOX = "//span[@id='LastName-error']";
